...
/*   Updated: 2025/12/09 13:35:56 by lisambet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Nick_cmd::parsing(std::string str, Server &serv, Client &main)
{
	...
	if (str.empty())
	{
		serv.sendMessageToClient(main.getFd(), "Error : no nickname given.\r\n");
		return;
	}
	if (str.size() > 9)
	{
		serv.sendMessageToClient(main.getFd(), "Error : please enter a nickname of maximum 9 characters.\r\n");
		return;
	}
	...
	for (size_t i = 0; i < clients.size(); i++)
	{
		...
		{
			serv.sendMessageToClient(main.getFd(), "Error : nickname unavailable.\r\n");
			return;
		}
	}
